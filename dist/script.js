  ...
  data() {
    return {
      ...
      artists: [
        {
          name: "BlueJeans",
          description: `BlueJeans are one of a kind, with their self titled album becoming one of the first on CherRi's platform, it was also the first to top the charts for over 5 weeks! 'Attention' would later become the first single to be certified Gold by the CherRi committee! The girls have made their names known, it's only time before they write it all in stone!`,
          spotify: {
            profileUrl: "https://cherrimusic.com/artist/40/bluejeans",
            embedUrl: "https://cherrimusic.com/artist/40/bluejeans"
          },
          backgroundUrl:
            "https://cherrimusic.com/storage/common_media/XnSBTYgITLhGDzeEVzTrZRY8WhNSPqmUdWmOi61j.png"
        },
        {
          name: "SOURPINK",
          description: `The second official act on CherRi, they held #2 for as long as anyone can remember with "Pink Venom" dominating the radio waves accompanied with the members solos taking dominance as well on the radio. SOURPINK's The Album ranks in the top 10 of the best albums on CherRi at the moment, and we can't wait for Born Pink!`,
          spotify: {
            profileUrl:
          ...
          backgroundUrl:
            "https://cherrimusic.com/storage/common_media/sbiQ7JWaKHC1Waur7njhzE4p9ddwltAKRSFKDJod.png"
        },
        {
          name: "Mallrat",
...
const _hoisted_6 = /*#__PURE__*/createElementVNode("img", {
  src: "https://i.ibb.co/MZRXkjF/Cher-Ri-Experiment.png",
